declare module "i18n-js" {
    ...
    function t(key: "platform.ios"): "Press Cmd+R to reload,\nCmd+D or shake for dev menu";
    function t(key: "platform.android"): "Double tap R on your keyboard to reload,\nShake or press menu button for dev menu";
    ...
    function t(key: "auth.signIn.dontHaveAnAccount"): "Don't have an account yet?";
    ...
    function t(key: "auth.signUp.alreadyHaveAnAccount"): "Do you already have an account?";
