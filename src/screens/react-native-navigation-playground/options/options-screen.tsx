...
export default class Options extends React.Component<Props> {
    ...
    return {
      topBar: {
        ...
        rightButtons: [
          {
            id: 'ONE',
            testID: testIDs.BUTTON_ONE,
            text: 'One',
            color: Colors.primary,
          },
          {
            id: 'ROUND',
            testID: testIDs.ROUND_BUTTON,
            component: {
        ...
        leftButtons: [
          {
            id: 'LEFT',
            testID: testIDs.LEFT_BUTTON,
            icon: require('src/assets/images/clear.png'),
            color: Colors.primary,
          },
        ],
      },
  ...
  render(): JSX.Element {
    return (
      <Root componentId={this.props.componentId}>
        <Button
          title="Change title"
          testID={testIDs.CHANGE_TITLE_BTN}
          onPress={this.changeTitle}
        />
        <Button
          title="Hide TopBar"
          testID={testIDs.HIDE_TOP_BAR_BTN}
          onPress={this.hideTopBar}
        />
        <Button
          title="Show TopBar"
          testID={testIDs.SHOW_TOP_BAR_BTN}
          onPress={this.showTopBar}
        />
        <Button title="Push" testID={testIDs.PUSH_BTN} onPress={this.push} />
        <Button
          title="Hide TopBar in DefaultOptions"
          testID={testIDs.HIDE_TOPBAR_DEFAULT_OPTIONS}
          onPress={this.hideTopBarInDefaultOptions}
        />
        <Button
          title="Set React Title View"
          testID={testIDs.SET_REACT_TITLE_VIEW}
          onPress={this.setReactTitleView}
        />
        <Button
          title="Show Yellow Box"
          testID={testIDs.SHOW_YELLOW_BOX_BTN}
  ...
  private hideTopBarInDefaultOptions = () => {
  ...
  private push = () => Navigation.push(this, Screens.Pushed);
