...
import LottieExamplePicker, { IExample } from '../example-picker';
...
const makeExample = (name: string, getJson: () => AnimationObject, width?: number): IExample => {
...
export default class LottieAnimatedExample extends React.Component<{}, State> {
  ...
  manageAnimation = (shouldPlay: boolean): void => {
  ...
  render() {
    ...
    console.log(require('../../assets/animations/HamburgerArrow.json'));
    return (
      <View style={{ flex: 1 }}>
        <LottieExamplePicker
          example={example}
